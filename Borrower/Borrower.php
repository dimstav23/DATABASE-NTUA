...
<html>
	...
	<body>
		<p id="names"></p>
		<div id="mytitle">
			<h1><em>Borrowers' Table</em></h1>
		</div>		
		<div class="menu2">
		    <a href="../Borrower/Borrower.php" class="current">Borrower</a>
...
function updateRow(tableID) {
	...
	//	if(!PostalCode) PostalCode=-1;
		...
		<?php
            		...
            		$results = mysqli_query($connect,"SELECT * FROM Borrower");
		?>
		<tr id="firstrow"><th></th><th>BId</th><th>Name</th><th>Town</th><th>Street Name</th><th>Street Number</th><th>Postal Code</th></tr>			
		<?php
		...
		?>
			    ...
			    <td><input type="radio" name="check[]" class="mybox" style="background-color:#000000"/></td>
		            <td style="background: hsl(50, 50%, 80%)" id="mykey"><?php echo $row['BId']?></td>
		...
		<div id="popup2" class="overlay">
			<div class="popup">
				...
				<div class="content">
						<button type="button" id="submit" onClick="deleteRow('Borrower')">Yes</button>
						<a href="Borrower.php"><button type="button"  id="delete" >No</button></a>
				</div>
			</div>
		</div>
			...
			<div class="popup">
				...
				<div class="content">
					 <form  id="myform" method="post">
						...
						<input type="int" name="PostalCode"><br>
						<!--<input type="submit" name="submit" class="submit" id="submit" value="Submit">-->
						<button type="button" class="submit" id="submit" onClick="updateRow('Borrower') ">Submit</button>
					</form> 
				</div>
			</div>
		</div>
