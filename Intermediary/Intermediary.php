...
<html>
	...
	<body>
		<p id="names"></p>
		<div id="mytitle">
			<h1><em>Intermediary's Table</em></h1>
		</div>	
		<div class="menu2">
		    ...
		    <a href="../Intermediary/Intermediary.php" class="current">Intermediary</a>
...
function updateRow(tableID) {
	...
	//	if(!PostalCode) PostalCode=-1;
		...
		<table id="Intermediary">
		<?php
            		$connect = mysqli_connect("localhost","root", "m4t0p9h9","project");
            		if (!$connect) {
                			die(mysql_error());
            		}
            		$results = mysqli_query($connect,"SELECT * FROM Intermediary");
		?>
		<tr id="firstrow"><th></th><th>MId</th><th>Name</th><th>Town</th><th>Street Name</th><th>Street Number</th><th>Postal Code</th></tr>			
		<?php
		...
		<div id="popup2" class="overlay">
			<div class="popup">
				...
				<div class="content">
						<button type="button" id="submit" onClick="deleteRow('Intermediary')">Yes</button>
						<a href="Intermediary.php"><button type="button"  id="delete" >No</button></a>
				</div>
			</div>
		</div>
			...
			<div class="popup">
				...
				<div class="content">
					 <form  id="myform" method="post">
						...
						<input type="int" name="PostalCode"><br>
						<!--<input type="submit" name="submit" class="submit" id="submit" value="Submit">-->
						<button type="button" class="submit" id="submit" onClick="updateRow('Intermediary') ">Submit</button>
					</form> 
				</div>
			</div>
		</div>
