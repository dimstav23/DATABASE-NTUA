...
<html>
	...
	<body>
		...
		<div class="menu2">
		    ...
		    <a href="../Repayment/Repayment.php" class="current">Repayment</a>
...
function updateRow(tableID) {
	...
	//	if(!PostalCode) PostalCode=-1;
		...
		<?php
            		...
            		$results = mysqli_query($connect,"SELECT * FROM Repayment");
		?>
		<tr id="firstrow"><th></th><th>Id</th><th>Date of Payment</th><th>Amount</th></tr>			
		<?php
		...
		?>
			    ...
			    <td><input type="radio" name="check[]" class="mybox" style="background-color:#000000"/></td>
		            ...
		            <td style="background: hsl(50, 50%, 80%)"><?php echo $row['DateOfPayment']?></td>
		...
		<div id="popup2" class="overlay">
			<div class="popup">
				...
				<div class="content">
						<button type="button" id="submit" onClick="deleteRow('Repayment')">Yes</button>
						<a href="Repayment.php"><button type="button"  id="delete" >No</button></a>
				</div>
			</div>
		</div>
			...
			<div class="popup">
				...
				<div class="content">
					 <form  id="myform" method="post">
						...
						<input type="int" name="Amount"><br>
						<!--<input type="submit" name="submit" class="submit" id="submit" value="Submit">-->
						<button type="button" class="submit" id="submit" onClick="updateRow('Repayment') ">Submit</button>
					</form> 
				</div>
			</div>
		</div>
