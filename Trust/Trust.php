...
<html>
	...
	<body>
		...
		<div class="menu2">
		    ...
		    <a href="../Trust/Trust.php" class="current">Trust</a>
...
function updateRow(tableID) {
	...
	//	if(!PostalCode) PostalCode=-1;
		...
		<?php
            		...
            		$results = mysqli_query($connect,"SELECT * FROM Trust");
		?>
		<tr id="firstrow"><th></th><th>BId</th><th>LId</th><th>Percentage</th></tr>			
		<?php
		...
		<div id="popup1" class="overlay">
			<div class="popup">
				<h2>Fill our form with caution!!</h2>
		...
		<div id="popup2" class="overlay">
			<div class="popup">
				...
				<div class="content">
						<button type="button" id="submit" onClick="deleteRow('Trust')">Yes</button>
						<a href="Trust.php"><button type="button"  id="delete" >No</button></a>
				</div>
			</div>
		</div>
		...
		<div id="popup3" class="overlay">
			<div class="popup">
				...
				<a class="close" href=""><button type="button" id="delete">Cancel</button></a>
				<!--<a class="submit" href="Insert.php"><button type="sumbit" id="submit" >Submit</button></a>-->
				<div class="content">
					 <form  id="myform" method="post">
						...
						<input type="int" name="Percentage"><br>
						<!--<input type="submit" name="submit" class="submit" id="submit" value="Submit">-->
						<button type="button" class="submit" id="submit" onClick="updateRow('Trust') ">Submit</button>
					</form> 
				</div>
			</div>
		</div>
