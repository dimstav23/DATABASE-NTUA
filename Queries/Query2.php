...
<html>
	...
	<body>
		...
		<center><h2>Borrower's with highest Trust Percentage from Lenders</h2></center>
		<table id="Borrower">
		<?php
            		...
            		$results = mysqli_query($connect,"SELECT Borrower.Name AS Bname , Trust.Percentage AS TP, Lender.Name AS LN
								FROM Borrower, Trust , Lender 
								WHERE Borrower.BId=Trust.BId AND Trust.LId = Lender.LId
								ORDER BY Trust.Percentage DESC");
		?>
		<tr id="firstrow"><th>Borrower's Name</th><th>Trust Percentage</th><th>Lender's Name</th></tr>			
		<?php
