...
<html>
	...
	<body>
		...
		<center><h2>Number of Requests each borrower applied</h2></center>
		<table id="Borrower">
		<?php
            		...
            		$results = mysqli_query($connect,"SELECT Borrower.Name AS Bname , COUNT(LoanRequest.BId) AS LR
							 FROM LoanRequest
							 LEFT JOIN Borrower
							 ON Borrower.BId=LoanRequest.BId
							 GROUP BY Borrower.Name;");
		?>
		<tr id="firstrow"><th>Borrower's Name</th><th>Total Requests</th></tr>			
		<?php
