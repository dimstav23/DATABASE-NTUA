...
<html>
	...
	<body>
		...
		<center><h2>Borrowers living in Athens</h2></center>
		<table id="Borrower">
		<?php
            		...
            		$results = mysqli_query($connect,"SELECT Borrower.BId,Borrower.Name FROM Borrower WHERE Borrower.Town='Athens' ");
		?>
		<tr id="firstrow"><th>BId</th><th>Name</th></tr>			
		<?php
