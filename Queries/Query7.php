...
<html>
	...
	<body>
		...
		<center><h2>Lenders willing to give more than 15.000 for borrowers</h2></center>
		<table id="Borrower">
		<?php
            		...
            		$results = mysqli_query($connect,"SELECT Lender.Name AS L, SUM(Commitment.Amount) AS MYS
								FROM Lender
		...
		?>
		<tr id="firstrow"><th>Lenders's Name</th><th>Amount to Commit (more than 5k)</th></tr>			
		<?php
