...
<html>
	...
	<body>
		...
		<center><h2>How much lenders are ready to lend??</h2></center>
		<table id="Borrower">
		<?php
            		...
            		$results = mysqli_query($connect,"SELECT Lender.Name AS Lname , SUM(Commitment.Amount) AS AM
								FROM Lender,Commitment 
								WHERE Lender.LId=Commitment.LId
								GROUP BY Lender.LId DESC");
		?>
		<tr id="firstrow"><th>Lender's Name</th><th>Amount available to lend</th></tr>			
		<?php
