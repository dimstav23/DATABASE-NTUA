...
<html>
	...
	<body>
		...
		<center><h2>Deadlines on demand!</h2></center>
		<table id="Borrower">
		<?php
            		...
            		$results = mysqli_query($connect,"SELECT Borrower.Name AS Bname , LoanRequest.DateOfRequest AS DOR ,LoanRequest.DeadLine AS DEAD
								FROM Borrower, LoanRequest
								WHERE Borrower.BId=LoanRequest.BId 								
								ORDER BY LoanRequest.DeadLine DESC");
		?>
		<tr id="firstrow"><th>Borrower's Name</th><th>Date Of Request</th><th>Deadline</th></tr>			
		<?php
