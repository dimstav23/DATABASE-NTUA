...
<html>
	...
	<body>
		...
		<center><h2>Intermediaries and their Obligations-Loans</h2></center>
		<table id="Borrower">
		<?php
            		...
            		$results = mysqli_query($connect,"SELECT Intermediary.MId AS M,Intermediary.Name AS N,Loan.Id AS ID
							FROM Intermediary
							INNER JOIN Loan
							ON Intermediary.MId=Loan.MId
							ORDER BY Loan.DateOfRequest ");
		?>
		<tr id="firstrow"><th>Intermediary's MId</th><th>Intermediary's Name</th><th>Loan ID</th></tr>			
		<?php
