...
<html>
	...
	<body>
		...
		<center><h2>Loyal Lenders!!</h2><center>
		<table id="Borrower">
		<?php
            		...
            		$results = mysqli_query($connect,"SELECT Lender.Name AS Lname , AVG(Trust.Percentage) AS TP
								FROM Borrower, Trust , Lender 
								WHERE Trust.LId = Lender.LId
								GROUP BY Lender.Name 
								ORDER BY AVG(Trust.Percentage) DESC");
		?>
		<tr id="firstrow"><th>Lender's Name</th><th>Average Trust Percentage</th></tr>			
		<?php
